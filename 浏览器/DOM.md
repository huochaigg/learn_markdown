...
![](media/网络进程是如何将数据传给HTML解析器.jpeg)
...
[来源: 前端面试题宝典](https://fe.ecool.fun/topic/45affa79-be16-4489-b403-bf3d614fcf03?orderBy=default&order=desc&tagId=12&exerciseCate=0&ignoreMaster=1&difficulty=)